	...
	<ul class="list">
		...
		foreach ( $organizer_ids as $organizer ) {
			...
			<span class="tribe-organizer">
				<?php esc_html_e('Name: ', 'governlia'); echo tribe_get_organizer_link( $organizer ) ?>
			</span>
			</li>
			<?php
		}
		...
		if ( ! $multiple ) { // only show organizer details if there is one
			if ( ! empty( $phone ) ) {
				...
				<li><span class="icon flaticon-telephone"></span>
					<?php esc_html_e( 'Phone: ', 'governlia' ) ?>
			...
			if ( ! empty( $email ) ) {
				...
				<li><span class="icon flaticon-note"></span>
					<?php esc_html_e( 'Email: ', 'governlia' ) ?>
			...
			if ( ! empty( $website ) ) {
				...
				<li><span class="icon flaticon-internet"></span>
					<?php esc_html_e( 'Website: ', 'governlia' ) ?>
